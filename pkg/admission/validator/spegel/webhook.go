...
const (
	...
	Name = "registry-spegel-validator"
)

var logger = log.Log.WithName("registry-spegel-validator-webhook")
...
func New(mgr manager.Manager) (*extensionswebhook.Webhook, error) {
	...
	return extensionswebhook.New(mgr, extensionswebhook.Args{
		...
		ObjectSelector: &metav1.LabelSelector{
			MatchLabels: map[string]string{"extensions.extensions.gardener.cloud/registry-spegel": "true"},
		},
	})
}
