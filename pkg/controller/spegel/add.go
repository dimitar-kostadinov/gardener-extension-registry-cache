...
const (
	...
	// ControllerName is the name of the registry spegel controller.
	ControllerName = "registry-spegel-controller"
	// FinalizerSuffix is the finalizer suffix for the registry spegel controller.
	FinalizerSuffix = "registry-spegel"
)
