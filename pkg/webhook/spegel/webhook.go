...
var logger = log.Log.WithName("registry-spegel-webhook")

// New returns a new mutating webhook that for a registry-spegel Extension adds the spegel unit to the OperatingSystemConfig resource.
